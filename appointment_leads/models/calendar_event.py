...
class CalendarEvent(models.Model):
    ...
    x_send_email_from_website = fields.Boolean(string="Envío de correo desde sitio web", default=False, copy=False)
    ...
    def get_patients_email(self):
        emails = self.partner_ids.filtered(lambda partner: partner.x_studio_es_paciente).mapped("email")
