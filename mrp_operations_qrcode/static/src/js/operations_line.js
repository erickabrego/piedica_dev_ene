odoo.define('mrp_operations_qrcode.OperationsLine', function(require) {
    ...
    var OperationsLine = Widget.extend({
        ...
        init: function(parent, order_id, animation_type) {
        ...
        _fetch_order: function() {
            ...
            return this._rpc({
                ...
                self.components = self.mrp_order.move_raw_ids.map((component) => component.product_id.name).join(', ');
        ...
        // Actualiza la información que se muestra en pantalla de la orden
        ...
        // Animación para hacer aparecer la primera linea. Se usa cuando se
        // escanea una orden que no está en pantalla
        fade_in: function () {
            this.$el.css({
                opacity: 0
            }).animate({
        ...
        // Animación que hace la ilusión que la primera línea viene de abajo. Se
        // usa en conjunto con "take_out" cuando se escanea una orden que
        // ya está en pantalla
        slide_up: function () {
            this.$el.css({
                zIndex: 90,
        ...
        // Animación que hace la ilusión que la orden escaneada va hacia arriba
        // para ponerse como primera línea
        take_out: function() {
            var self = this;
